...
class CriteriaController extends Controller
{
  ...
  {
    try{
        $criterias = Criteria::where('is_deleted', false)->get();
        if (!$criterias) {
            return response()->json('criteria not found');
        }
  ...
  public function block(string $id)
{
    try{
            ...
            return response()->json(['data' => 'This criteria is block successfuly.'], 200);
...
public function unblock(string $id)
{
    try{
            ...
            return response()->json(['data' => 'this criteria is unblock successfuly.'], 200);
    } catch(Exception $e) {
        return response()->json($e);
    }
